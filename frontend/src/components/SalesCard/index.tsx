        ...
        <table className="dsmeta-sales-table">
          ...
          <tbody>
            {sales.map((sale) => {
              return (
                <tr key={sale.id}>
                  <td className="dsmta-breakpoint-large">{sale.id}</td>
                  <td className="dsmta-breakpoint-small">{new Date (sale.date).toLocaleDateString()}</td>
                  <td>{sale.sellerName}</td>
                  <td className="dsmta-breakpoint-large">{sale.visited}</td>
                  <td className="dsmta-breakpoint-large">{sale.deals}</td>
